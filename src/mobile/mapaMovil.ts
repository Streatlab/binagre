...
export const SECCIONES: SeccionMovil[] = [
  {
    ...
    items: [
      { path: '/finanzas/documentacion', label: 'Papeleo', emoji: '📥', desc: 'Buzón y lectura de facturas', perfiles: ['admin'] },
      { path: '/facturacion', label: 'Facturación', emoji: '🧾', desc: 'Facturas y conciliación', perfiles: ['admin'] },
      { path: '/finanzas/ventas', label: 'Ventas', emoji: '💰', desc: 'Por canal, marca y día', perfiles: ['admin'] },
      { path: '/finanzas/objetivos', label: 'Objetivos', emoji: '🎯', desc: 'Metas y progreso', perfiles: ['admin'] },
      { path: '/finanzas/punto-equilibrio', label: 'Punto de Equilibrio', emoji: '⚖️', desc: 'Cuánto hay que vender', perfiles: ['admin'] },
      { path: '/finanzas/running', label: 'Running', emoji: '📊', desc: 'Cuenta de resultados', perfiles: ['admin'] },
      { path: '/finanzas/pagos-cobros', label: 'Pagos y Cobros', emoji: '💳', desc: 'Qué entra y qué sale', perfiles: ['admin'] },
      { path: '/finanzas/reservas', label: 'Reservas', emoji: '🏦', desc: 'Colchón y provisiones', perfiles: ['admin'] },
      { path: '/finanzas/verifactu', label: 'Verifactu', emoji: '✅', desc: 'Facturas emitidas', perfiles: ['admin'] },
      { path: '/finanzas/escenarios-tesoreria', label: 'Escenarios Tesorería', emoji: '🔮', desc: 'Simulaciones de caja', perfiles: ['admin'] },
      { path: '/finanzas/tesoreria-13-semanas', label: 'Tesorería 13 Semanas', emoji: '📅', desc: 'Caja a 3 meses', perfiles: ['admin'] },
      { path: '/finanzas/fondo-maniobra', label: 'Fondo de Maniobra', emoji: '⚙️', desc: 'Colchón operativo', perfiles: ['admin'] },
      { path: '/finanzas/estados-financieros', label: 'Estados Financieros', emoji: '📑', desc: 'Balance y P&G', perfiles: ['admin'] },
      { path: '/finanzas/break-even', label: 'Break-even Marca/Canal', emoji: '📐', desc: 'Rentabilidad por marca', perfiles: ['admin'] },
      { path: '/finanzas/analisis-horizontal-vertical', label: 'Análisis Horiz./Vert.', emoji: '📉', desc: 'Comparativa de partidas', perfiles: ['admin'] },
      { path: '/finanzas/panel-alertas', label: 'Panel de Alertas', emoji: '🚨', desc: 'Avisos financieros', perfiles: ['admin'] },
      { path: '/finanzas/repeticion-clientes', label: 'Repetición Clientes', emoji: '🔁', desc: 'Clientes que vuelven', perfiles: ['admin'] },
      { path: '/finanzas/roi-canal', label: 'ROI por Canal', emoji: '🏆', desc: 'Qué canal renta', perfiles: ['admin'] },
      { path: '/finanzas/ticket-medio', label: 'Ticket Medio', emoji: '🎫', desc: 'Gasto por pedido', perfiles: ['admin'] },
      { path: '/finanzas/lineas-factura', label: 'Líneas de Factura', emoji: '🧩', desc: 'Detalle por artículo', perfiles: ['admin'], pendiente: true },
      { path: '/finanzas/rentabilidad-franja', label: 'Rentab. por Franja', emoji: '🕐', desc: 'Comida vs cena', perfiles: ['admin'], pendiente: true },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/cocina/duplicados-platos', label: 'Platos Duplicados', emoji: '👯', desc: 'Nombres repetidos', perfiles: ['admin'], pendiente: true },
