...
import { CONFIG_MUT, CONFIG_BORDE_ALT, CONFIG_BORDE_ALT2 } from '@/styles/palettes'
...
export function TH({
  ...
  const border = isDark ? INK : CONFIG_BORDE_ALT
  return (
    <th
      style={{
        fontSize: 11,
...
export function TD({
  ...
  const isDark = useIsDark()
  const border = isDark ? INK : CONFIG_BORDE_ALT2
