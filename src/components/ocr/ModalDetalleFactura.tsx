import { BLANCO, BORDE_SUAVE, CREMA, GRANATE, GRIS, INK, NAR, OSC, ROJO, VERDE } from '@/styles/neobrutal'
import { OCR_NAR_WASH_BG, OCR_NAR_WASH_TXT, COBERTURA_VERDE, CANAL_UBER_DARK, OCR_ROJO_WASH_CLARO, CORREO_ERROR_BORDE, OCR_FOOTER_BG } from '@/styles/palettes'
