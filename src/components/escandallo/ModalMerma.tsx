...
export default function ModalMerma({ merma, onClose, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 p-4 overflow-y-auto" onClick={onClose}>
      <div className="modal-merma border border-[#4a5270] w-full max-w-4xl my-8 shadow-2xl" style={{ backgroundColor: '#575e7a', borderRadius: '10px' }} onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="border border-[#4a5270] rounded-lg p-4 space-y-3" style={{ backgroundColor: '#4e5470' }}>
