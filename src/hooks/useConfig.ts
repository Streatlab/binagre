...
// (Tanda D2) La huérfana calcWaterfall() que vivía aquí se ha retirado: el waterfall
// vivo del Escandallo es src/utils/waterfallReceta.ts (computeWaterfall), única fuente.
