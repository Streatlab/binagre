  ...
  return (
    <div>
      ...
      >
        ...
        <p style={{ fontFamily: 'Oswald, sans-serif', fontSize: 14, color: '#cccccc', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
          En construcción
        </p>
        <p style={{ fontFamily: 'Lexend, sans-serif', fontSize: 13, color: '#999999', marginTop: 8 }}>
          Este módulo está planificado y se implementará próximamente.
        </p>
        <code
          className="inline-block mt-5 px-3 py-1 rounded"
          style={{ fontFamily: 'monospace', fontSize: 11, background: '#111111', color: '#66aaff', border: '1px solid #2a2a2a' }}
        >
          {location.pathname}
        </code>
      </div>
