  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ background: '#484f66', borderColor: '#4a5270' }}
      >
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-full mb-4"
          style={{ background: '#3a4058', border: '1px solid #4a5270' }}>
          <span style={{ fontSize: 24 }}>🚧</span>
        </div>
        <p style={{ fontFamily: 'Oswald, sans-serif', fontSize: 14, color: '#c8d0e8', letterSpacing: '0.06em', textTransform: 'uppercase' }}>
          En construcción
        </p>
        <p style={{ fontFamily: 'Lexend, sans-serif', fontSize: 13, color: '#7080a8', marginTop: 8 }}>
          Este módulo está planificado y se implementará próximamente.
        </p>
        <code
          className="inline-block mt-5 px-3 py-1 rounded"
          style={{ fontFamily: 'monospace', fontSize: 11, background: '#2e3347', color: '#66aaff', border: '1px solid #4a5270' }}
        >
          {location.pathname}
        </code>
      </div>
