            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-3.5" style={{ marginBottom:20 }}>
              ...
              <div style={cardStyle(T)}>
                ...
                <div style={{ display:'flex', gap:16 }}>
                  {[{ label:'Almuerzo', color:'#f5a623' }, { label:'Cena', color:'#1E5BCC' }].map(s => (
            ...
            <div style={cardStyle(T)}>
              ...
              <div style={{ overflowX:'auto' }}>
                <table style={{ width:'100%', borderCollapse:'collapse', fontFamily:'Lexend,sans-serif', fontSize:12 }}>
                  <thead>
                    <tr>{['Marca','Canal','ADS mes','ADS últ 3 meses'].map(h => (
                  ...
                  <tbody>
                    <tr><td colSpan={4} style={{ padding:'16px 10px', color:T.mut, textAlign:'center', fontFamily:'Lexend,sans-serif', fontSize:12 }}>
