/**
 * PyG — ex Running V2 (renombrado 18 may 2026)
 * Mantiene la estructura original: 4 tabs Resumen/PyG/Marcas/Comparativas
 * con useRunningV2 y los componentes existentes.
 */
