...
import PendientesAlerta from '@/components/ocr/PendientesAlerta'
...
export default function Ocr() {
  ...
  return (
    <div style={groupStyle(T)}>
      ...
      {tab === 'ventas' && (<div style={{ marginTop: 14 }}><CardFacturasCorreo tipo="ventas" /><VentasTab fechaDesde={fechaDesde} fechaHasta={fechaHasta} titulares={titulares} /></div>)}
      {(tab === 'facturas' || tab === 'otros') && (<>
        ...
        {tab === 'facturas' && (<CardFacturasCorreo tipo="factura" />)}
        {tab === 'facturas' && (<PendientesAlerta desde={periodoDesdeStr} hasta={periodoHastaStr} onReconciliado={() => setRefreshTick(x => x + 1)} />)}
