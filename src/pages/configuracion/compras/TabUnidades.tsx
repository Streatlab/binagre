...
export default function TabUnidades() {
  return (
    <PantallaCantera embedded>
      <HeroCantera
        area="equipo"
        titular="Así tienes organizadas tus unidades"
        resumen="Unidades, unidades estándar, mínimas y formatos de compra: cada lista alimenta un modal distinto de Escandallo."
      />
