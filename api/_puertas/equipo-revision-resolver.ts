// _puertas/equipo-revision-resolver.ts — reasigna el tipo correcto a una fila
...
// (vive en _puertas: se sirve a través de la puerta /api/operaciones, que
// rellena req.query.id desde la ruta /api/equipo/revision/:id/resolver)
